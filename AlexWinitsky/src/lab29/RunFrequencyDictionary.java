...
public class RunFrequencyDictionary {
    public static void main(String[] args) {
        ...
        Map<String, Integer> frequencyDictionary = dictionary.createFrequencyDictionary(str);
        dictionary.printFrequencyDictionary(frequencyDictionary);
        System.out.println("Частотный славарь с сортировкой по возрастанию");
        dictionary.sortFrequencyDictionary(frequencyDictionary);
